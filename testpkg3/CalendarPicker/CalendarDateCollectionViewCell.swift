...
class CalendarDateCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        // changes (e.g. entering split view on iPad) to update constraits correctly.
        // remove old constraints allows for new ones to be created
...
private extension CalendarDateCollectionViewCell {
    ...
    func updateSelectionStatus() {
        ...
        if day.isSelected {
            ...
            applyDefaultStyle(isWithinDisplayedMonth: day.isWithinDisplayMonth)
        }
    }
